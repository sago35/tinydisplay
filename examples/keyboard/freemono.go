...
var Regular9pt7b = tinyfont.Font{
	Glyphs: []tinyfont.Glyph{
		...
		/* 0x101 */ tinyfont.Glyph{Rune: 0x101, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x00, 0x02, 0x00, 0x40, 0x08, 0x41, 0x10, 0x27, 0xFC, 0x40, 0x04, 0x00, 0x00, 0x00, 0x00}},
		/* 0x102 */ tinyfont.Glyph{Rune: 0x102, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x04, 0x08, 0x81, 0x90, 0x3B, 0xFF, 0xC0, 0xE8, 0x19, 0x02, 0x20, 0x04, 0x00, 0x00, 0x00}},
		/* 0x103 */ tinyfont.Glyph{Rune: 0x103, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x0F, 0xE2, 0x04, 0x80, 0xA4, 0x58, 0x53, 0x04, 0x61, 0x4A, 0x45, 0x20, 0x22, 0x04, 0x3F, 0x80, 0x00}},
		/* 0x106 */ tinyfont.Glyph{Rune: 0x106, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x08, 0x00, 0xBF, 0xF8, 0x02, 0x00, 0x80, 0x20, 0x00, 0x00, 0x00}},
		/* 0x107 */ tinyfont.Glyph{Rune: 0x107, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x00, 0x00, 0x08, 0x02, 0x00, 0x80, 0x3F, 0xFA, 0x00, 0x20, 0x02, 0x00, 0x00, 0x00, 0x00}},
		/* 0x108 */ tinyfont.Glyph{Rune: 0x108, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x80, 0x10, 0x02, 0x00, 0x40, 0x08, 0x01, 0x00, 0x20, 0x24, 0x82, 0xA0, 0x38, 0x02, 0x00}},
		/* 0x109 */ tinyfont.Glyph{Rune: 0x109, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x80, 0x38, 0x0A, 0x82, 0x48, 0x08, 0x01, 0x00, 0x20, 0x04, 0x00, 0x80, 0x10, 0x02, 0x00}},
		/* 0x1FF */ tinyfont.Glyph{Rune: 0x1FF, Width: 0xb, Height: 0xd, XAdvance: 0xb, XOffset: 0, YOffset: -10, Bitmaps: []uint8{0x00, 0x00, 0x03, 0xFF, 0xBF, 0xE7, 0xFC, 0x7F, 0x0F, 0xE0, 0xF8, 0x1F, 0x01, 0xC0, 0x10, 0x02, 0x00}},
	},
