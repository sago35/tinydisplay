...
func run() error {
	display, err := fynedisplay.NewClient("127.0.0.1", 9812, 320, 240)
	if err != nil {
		return err
	}
...
func drawPng(display *fynedisplay.Client) error {
...
func drawJpeg(display *fynedisplay.Client) error {
